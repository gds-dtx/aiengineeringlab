...
| Very large | Claude Sonnet 5, Claude Opus 5, Claude Opus 4.8, Claude Opus 4.7, Claude Opus 4.6, Gemini 2.5 Pro | 1,000,000 | ~4,000,000 characters |

Note: Claude Sonnet 5 uses a newer tokenizer, so equivalent text can map to more tokens than Sonnet 4.6. Recheck token counts when migrating prompts.
